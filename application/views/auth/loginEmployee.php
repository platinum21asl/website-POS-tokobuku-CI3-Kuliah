                    ...
                    <div class="col-lg-5">
                        <div class="card shadow-lg border-0 rounded-lg mt-5">
                            <div class="card-header">
                                <h3 class="text-center font-weight-light my-4">Login Employee</h3>
                            </div>
                            <?= $this->session->flashdata('message'); ?>
                            <div class="card-body">
                                <form class="form" method="post" action="<?= base_url('auth/Employee'); ?>">
                            ...
                            <div class="card-footer text-center py-3">
                                <div class="small"><a href="<?= base_url('auth/Employee/registration'); ?>">Need an account? Sign up!</a></div>
                            </div>
                        </div>
                    </div>
                </div>
