                    ...
                    <div class="row">
                        <div class="card col-sm-3">
                            <div class="card-body">
                                <div class="box-body">
                                    <div>
                                        <h4>Nomor Nota: <b><span datainvoice="invoice" style="font-size:20pt"><?= $kode_beli ?></span></b></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="card col-sm-4">
                            <div class="card-body">
                                <div class="box-body">
                                    <div>
                                        <h2>Total Bayar: </h2><b><span data-total="total" style="font-size:20pt">Rp. <?= $total; ?>,-</span></b>
                                        <!-- DISINI KURANG FONT -->
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-5">
                            <Form method="post" name='autoSumForm'>
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="number" class="formcontrol" name='Uang_Pembayaran' size='23' onFocus="startCalc();" onBlur="stopCalc();" />
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="number" class="formcontrol" value='0' name="Kembalian" onchange='tryNumberFormat(this.form);' readonly>
                                        </div>
                                    </div>
                                </div>
                            </form>
                            ...
                            <a class="btn btn-flat btn-lg btn-warning" href="<?= base_url('admin/pembelian/clear_cart'); ?>">
                                Cancel
                            </a>
