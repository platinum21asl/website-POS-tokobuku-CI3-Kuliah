            ...
            <main>
                <div class="container-fluid">
                        ...
                        <div class="card-body">
                            <form class="form-horizontal" method="post" action="<?php echo base_url('admin/penjualan/chart'); ?>">
                                ...
                                <p class="font-weight-lighter">
                                    ...
                                    <br>e.g. End Date : 01/20/2020 &rarr; <strong> 01/21/2020 </strong>.
                                </p>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body"><canvas id="pnjLine" width="80%" height="30">
                            </canvas></div>
                    ...
                    <div class="card mb-4">
                        ...
                        6
                        <div class="card-body"><canvas id="pnjBar" width="100%" height="30">
                            </canvas></div>
                        <div class="card-footer small text-muted"></div>
                    </div>
